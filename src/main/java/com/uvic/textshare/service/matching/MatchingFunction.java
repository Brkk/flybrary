...
+ " <header class='header' style='flex: 1 100%; font-size: 36px; line-height: 1.2; color: #000; font-weight: 200; margin: 20px 0 10px; padding: 10px;'><p style='font-size: 16pt; text-align: left;' align='left'>Oh hey there,</p>"
+"<p>Isn't this a lucky day for ya. Remember that time you used flybrary for \"" + title + "\". Well, we found "
+ "you match. You can leave whatever you are doing and reach your lovely match</p>"
...
+      "It Flew!</div>"
+  	"</article><footer class='footer' style='flex: 1 100%; padding: 10px;'><p style='text-align: center; font-size: 12pt; margin-top: 40px;' align='center'><p>Have a fantastic day and remember to always fly with flybrary.</p><p></p><p></p>"
+ "<p>Regards</p>"
+ "<p>Kisses from Team Flybrary</p>"
+"<p>"
+"</p>"
